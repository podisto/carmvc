...
public class CarServiceImpl implements CarService {
	...
	public CarServiceImpl() {
		carList.add(new Car(id++, "Primera", "Nissan", "/img/car1.png",
				...
				23320));
		carList.add(new Car(id++, "Cefiro", "Nissan", "/img/car2.png",
				...
				38165));
		carList.add(new Car(id++, "Camry", "Toyota", "/img/car3.png",
				...
				24170));
		carList.add(new Car(id++, "Century", "Toyota", "/img/car4.png",
				...
				28730));
		carList.add(new Car(id++, "Sigma", "Mitsubishi", "/img/car5.png",
				...
				54120));
		carList.add(new Car(id++, "Challenger", "Mitsubishi", "/img/car6.png",
				...
				58750));
		carList.add(new Car(id++, "Civic", "Honda", "/img/car1.png",
				...
				17479));
		carList.add(new Car(id++, "New Beetle", "Volkswagen", "/img/car2.png",
				...
				67540));
		carList.add(new Car(id++, "Golf V", "Volkswagen", "/img/car3.png",
				...
				78200));
		carList.add(new Car(id++, "Neon", "Chrysler", "/img/car4.png",
